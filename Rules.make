...
# This should be run from every default rule
#
.PHONY: checkconfigure
checkconfigure: $(SRCDIR)/Rules.make
...
$(SRCDIR)/Rules.make: $(SRCDIR)/Rules.make.in $(SRCDIR)/configure
